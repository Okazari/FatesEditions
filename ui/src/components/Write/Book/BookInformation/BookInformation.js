...
import { Button, LabelInput, GroupInput, TextAreaInput } from 'components/common'
      ...
      <Box className="box-primary">
        ...
        <BoxBody>
          <div className={styles.bookCover}>
            ...
            <GroupInput resource={draft}
                        resourceHandler={updateResource}
                        domProps={{type: 'text', name:"cover", placeholder: "url de l'image de couverture", required: true}}>URL</GroupInput>
          </div>
          <div className={styles.bookInformation}>
            <LabelInput label="Titre"
                        resource={draft}
                        resourceHandler={updateResource}
                        domProps={{type: "text", name:"name", placeholder:"Titre du livre", required: true}}/>
            <GenreList defaultValue={draft.genreId}
                       resource={draft}
                       resourceHandler={updateResource}
                       domProps={{name:"genre", required: true}}/>
            <TextAreaInput label="Synopsis"
                           resource={draft}
                           resourceHandler={updateResource}
                           domProps={{name:"synopsis", placeholder:"Synopsis du livre", required: true}}/>
            <PageList query={{bookId: draft._id}}
