...
angular.module('myVirtualStoryBookApp')
  .controller('WriteBookController', function ($scope, IntroService, $state, $stateParams, GenreService, PlayerService, BookService, PageService, D3Service) {
    ...
    IntroService.launchTour("writebooktour");
