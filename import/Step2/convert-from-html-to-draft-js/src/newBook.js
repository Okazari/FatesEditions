...
[
	...
	},
	{
		...
		"text" : "<p style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\">Les règles<span class=\"Apple-converted-space\"> </span><br/>Cette aventure ne nécessite pas de dés. La réussite ne sera donc pas le fruit du hasard mais celui de votre sagacité.<br/></p><p style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\">Équipement<br/>Au départ de cette quête vous vous êtes vêtu de riches habits de soie et vous possédez une bourse de 10 pièces d'or ainsi qu'une dague richement ornée. Vous possédez aussi l'un des objets suivants, au choix :<span class=\"Apple-converted-space\"> </span><br/>• Friandises : vous en gardez toujours sur vous pour faire plaisir aux enfants que vous rencontrez, ou pour vous-même.<span class=\"Apple-converted-space\"> </span><br/>• Arme : prudent, une épée courte pend toujours à vos côtés, au cas où vous seriez victime d'un attentat.<span class=\"Apple-converted-space\"> </span><br/>• Or : vous gardez toujours dans votre poche une deuxième bourse bien arrondie pour ne pas rester démuni en cas de vol. Vous possédez donc 12 pièces d'or supplémentaires.<span class=\"Apple-converted-space\"> </span><br/>Vous pourrez bien entendu trouver d'autres accessoires durant cette aventure, mais comme vous n'avez pas de sac à dos, il ne devront pas être trop encombrants.<span class=\"Apple-converted-space\"> </span><br/></p><p style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"><br/></p>"
	},
	{
		"_id" : {
	...
	},
	{
		...
		"text" : "<p><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">Dès l'instant où ils vous remarquent, les brigands se jettent sur vous en sortant… des épées de bois. Vous vous retenez d'éclater de rire car leur mine n'est pas du genre à plaisanter. Ces épées de bois peuvent tout de même vous arracher des cris de douleur. Vous levez aussitôt les mains en l'air, et vous déclarez avoir l'intention de parlementer. L'un d'eux, légèrement mieux habillé que les autres, et portant un foulard rouge sort du groupe et vous dit :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);text-align: justify;background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">- Je me nomme Hedum, et si tu veux parler, c'est à moi qu'il faut s'adresser.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);text-align: justify;background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">Mettant alors vos années d'enseignement en négociation à profits, vous tentez de convaincre leur chef de ne pas frapper la jeune fille, que cela ne leur apporterait rien, et que vous leur promettez une récompense s'ils la laissent. Vous leur donnez, pour prouver votre bonne foi, 2 pièces d'or. Le chef empoche votre don et se retourne alors vers ses compagnons, et une brève conversation s'ensuit. Avez-vous réussi à convaincre les brigands ?</span><br/></p>"
	},
	{
		"_id" : {
		...
		"text" : "<p><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Dès l'instant où ils vous remarquent, les brigands se jettent sur vous en sortant… des épées de bois. Vous vous retenez d'éclater de rire car leur mine n'est pas du genre à plaisanter. Ces épées de bois peuvent tout de même vous arracher des cris de douleur. Vous levez aussitôt les mains en l'air, et vous déclarez avoir l'intention de parlementer. L'un d'eux, légèrement mieux habillé que les autres, et portant un foulard rouge, sort du groupe et vous dit :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Je me nomme Hedum, et si tu veux parler, c'est à moi qu'il faut s'adresser.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Mettant alors vos années d'enseignement en négociation à profits, vous tentez de convaincre leur chef de ne pas frapper la jeune fille, que cela ne leur apporterait rien, et que c'était déloyal car elle n'était pas du même sexe, qu'elle était sans défense et qu'elle était seule. Le chef se retourne alors vers ses compagnons, et un bref bavardage s'ensuit. Avez-vous réussi à convaincre les brigands ?</span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><br/></p>"
	},
	{
		"_id" : {
		...
		"text" : "<p style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"><u><b>Les talents spéciaux<span class=\"Apple-converted-space\"> </span></b></u><br/>Au cours des années, vous avez acquis certains talents particuliers. Vous ne pouvez en choisir que DEUX et seulement deux parmi les cinq qui vous sont proposés. Le choix de ces deux talents sera déterminant pour la réussite de l'aventure. Les voici :<span class=\"Apple-converted-space\"> </span><br/><u><b>Maître d'armes</b></u><span class=\"Apple-converted-space\"> </span>: Durant votre jeunesse, vous avez été entraîné au maniement des armes, principalement à l'épée, domaine où vous avez excellé. Pendant cet entraînement, vous avez aussi développé votre physique : ajoutez 1 point à votre total de constitution.<span class=\"Apple-converted-space\"> </span><br/><u><b>Éloquence</b></u><span class=\"Apple-converted-space\"> </span>: S'il le faut, vous savez vous montrer très persuasif et grâce à ce talent, vous pouvez manipuler les naïfs.<span class=\"Apple-converted-space\"> </span><br/><u><b>Acrobate</b></u><span class=\"Apple-converted-space\"> </span>: Si l'occasion se présente, vous pouvez facilement grimper à un arbre, un mur… ou alors faire un saut périlleux pour vous retrouver dans le  dos d'un ennemi et pouvoir l'attaquer par surprise.<span class=\"Apple-converted-space\"> </span><br/><u><b>Connaissance</b></u><span class=\"Apple-converted-space\"> </span>: Vous avez reçu pendant votre jeunesse une éducation érudite et vous possédez maintenant une grande connaissance du monde qui vous entoure.<span class=\"Apple-converted-space\"> </span><br/><u><b>Robustesse</b></u><span class=\"Apple-converted-space\"> </span>: Vous avez la capacité innée d'être plus robuste et plus fort que la moyenne des hommes. Ajoutez par conséquent 3 points à votre total de constitution. Vous êtes aussi d'une puissance exceptionnelle.<br/></p>"
	},
	{
		"_id" : {
		...
		"title" : "0",
		"description" : "Intro",
		"text" : "<p><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">En tant que membre de la noblesse, rien n'a jamais troublé votre petite vie paisible si ce n'est les quelques larcins commis sur votre personne. Vous parcourez souvent le pays pour des rencontres importantes. Aujourd'hui, vous partez en voyage pour avoir une audience auprès du roi pour lui quémander d'importantes parcelles de terres. Pour parer à un éventuel danger, vous êtes parti avec un jour d'avance. Ainsi, votre carrosse avance, et vos gardes ne rencontrent pas le moindre problème. Par la fenêtre de votre voiture, vous repérez une magnifique forêt bordée par un océan de blé. Vous décidez donc de vous accorder une courte pause dans ce lieu paradisiaque. Vous ordonnez au cocher d'arrêter le carrosse et vous vous dirigez d'un pas leste vers la forêt en laissant sur place vos serviteurs et vos gardes du corps. Après avoir parcouru les champs de blé, vous entrez dans cette forêt qui vous ouvre les bras. Vous vous allongez sur une souche bordée de fleurs jaunes et vous profitez du chant des oiseaux sous le soleil éclatant. Une fois l'heure venue de rejoindre votre carrosse, vous reprenez le même chemin qu'à l'aller mais une fois rendu à l'orée du bois, vous vous cognez contre une sorte de barrière invisible. Vous donnez un puissant coup d'épaule sur celle-ci mais cela ne fait qu'augmenter votre douleur. Après un nouvel essai infructueux, vous apercevez un vieillard encore ingambe sortant du néant. Ce dernier vous indique :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Ça ne sert à rien d'essayer de ressortir, vous n'y parviendrez jamais.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Que se passe-t-il ? demandez-vous affolé.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Vous n'allez sûrement pas me croire mais ce que je vais vous dire est la pure vérité, annonça l'inconnu. Sur cette forêt plane un puissant maléfice ainsi qu'une illusion : celle-ci rend le bois éblouissant de l'extérieur et on peut y entrer facilement. L'illusion dure encore quelques temps avant de s'estomper et de laisser place à la vraie nature de la forêt.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Vous regardez autour de vous et vous vous apercevez avec effroi que cette si belle forêt où vous étiez arrivé s'est transformée en un bois dépéri et lugubre, dont tous les arbres se ploient sous le poids de leurs branches.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Comme vous pouvez l'observer, reprit l'ancien, on a jeté sur cette futaie un maléfice de vieillissement, tous les êtres vivants qui y habitaient ont vieilli d'un seul coup. De plus, une fois à l'intérieur de la forêt, on ne peut en ressortir : un champ de force invisible et infranchissable bloque le passage.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- M…mais j'ai un…une rencontre impor…portante, balbutiez-vous éberlué.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Vous pourriez bien annuler le maléfice, mais cela ne sera pas une tâche aisée.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Comment puis-je repartir ? le suppliez-vous.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Pour annuler le sort, il faut réunir les quatre syllabes du mot de pouvoir grâce auquel on l'a lancé. Je ne sais pas où elles se trouvent exactement mais je sais qu'elles sont éparpillées dans la forêt, gardées précieusement par ceux qui les connaissent. Chacun n'en connaît qu'une seule et je ne peux malheureusement pas vous aider.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Mais qui donc a pu lancer ce sort ?<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- C'est moi, j'ai récité une formule pour laver mes bottes mais je me suis trompé à un moment et l'effet en a été complètement modifié.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Vous vous demandez comment cet homme peut faire un tel aveu d'une manière aussi désinvolte. Cache-t-il quelque secret ? Il vaut mieux partir loin de lui le plus vite possible.</span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Par où dois-je aller ? vous enquérez-vous.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Suivez la direction qui vous semble la meilleure. Et méfiez-vous, ce bois regorge de végétaux agressifs et des bandits y sévissent.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Vous ragez intérieurement : tout cela serait donc de la faute du vieillard ! Sur ces mots, le vieillard repart comme il est venu. Vous voici maintenant perdu dans une forêt dont vous ne pouvez ressortir à moins de découvrir les quatre syllabes d'un mot de pouvoir, tout cela à cause d'un court interlude ! Rendez-vous au 1.</span><br/></p>"
	},
	{
		"_id" : {
		...
		"title" : "16",
		"description" : "Linda",
		"text" : "<p><span class=\"rangySelectionBoundary\" id=\"selectionBoundary_1443960917637_21572136527129449\" style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\">&#65279;</span><span class=\"rangySelectionBoundary\" id=\"selectionBoundary_1443960928645_056821550425733336\" style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\">&#65279;</span><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Le brigand au foulard rouge vient vers vous et vous déclare :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Nous avons décidé de te remettre la jeune fille et de te laisser partir, mais à une seule condition.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Vous êtes bien honorable, lui assurez-vous sans vraiment le penser.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Vous devez nous donner cette dague magnifiquement ornée que vous avez là, ordonne-t-il en montrant le fourreau de votre arme.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Aussitôt, vous acceptez. Le chef s'empare de votre arme et se tourne vers ses compagnons pour montrer son nouveau trésor. Vous feriez n'importe quoi pour sauver cette jeune fille en détresse. Mais ce n'est qu'après, quand la victime des brigands est libérée, que vous vous rendez compte à quel point une arme vous serait utile pour votre tâche. La cible des crapules, aussitôt délivrée, vient vers vous et vous remercie :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Je me nomme Linda, et…<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Dégoûté par l'haleine fétide de la femme, vous tournez aussitôt la tête, ne lui laissant pas le temps de finir sa phrase.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Qu'il y a-t-il ?<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Je suis désolé, répondez-vous avec difficulté, je vis dans la haute société et ...</span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Moi, je ne connais guère la haute société. Je suis une fillette du village de Bellus. Il y a deux jours, j'ai senti un bourdonnement dans mes oreilles et je me suis mise à grandir subitement. Je suis alors sortie pour prévenir ma famille, mais tout le monde avait subi le même sortilège. Mes parents sont devenus vieux, mon grand-père est mort de vieillesse, ma sœur est devenue adulte, comme moi. Maintenant, j'essaie de fuir les brigands - les violents enfants du village qui ont vieilli - mais ils sont partout. J'essaie aussi de retrouver ma sœur. Je vous remercie de m'avoir tirée de ce mauvais pas. En gage de reconnaissance, je suis prête à tout faire pour toi.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Vous lui expliquez alors votre rendez-vous avec le roi, votre pause dans ce bois, la rencontre avec le vieillard et votre seule chance de quitter la forêt : trouver les quatre syllabes du mot de pouvoir. Elle vous indique alors que pour trouver des érudits, il faut se rendre dans son village qui se trouve à l'ouest de la forêt. Elle vous supplie aussi, une fois arrivé au village, de remettre à son père sa bague. Elle vous tend alors une bague tressée avec des lianes, des tiges et des cheveux, qui forment un enchevêtrement tout à fait magnifique. Puis, après un long adieu, elle vous quitte, en vous indiquant qu'elle va essayer de trouver sa sœur. Ajoutez un point au temps écoulé. Puis, vous avez le choix entre deux pistes pour poursuivre votre route. L'une mène au nord vers des arbres épineux et l'autre se dirige vers l'est où vous percevez un faible bruit.</span><br/></p>"
	},
	{
		"_id" : {
		...
		"text" : "<p><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Les brigands rejettent votre proposition et vous demandent des friandises si vous voulez qu'ils laissent la jeune fille en paix. Voilà des brigands peu ordinaires ! <span class=\"Apple-converted-space\"> </span></span><br/></p>"
	},
	{
		"_id" : {
	...
	},
	{
		...
		"__v" : 0,
		"title" : "42",
		"text" : "<p><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Vous poursuivez votre progression dans la forêt et peu après, vous remarquez un carré d'herbes à la couleur turquoise qui borde le sentier. <span class=\"Apple-converted-space\"> </span></span><br/></p>"
	},
	{
		"_id" : {
		...
		"title" : "12",
		"description" : "Herbes",
		"text" : "<p><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Vous reconnaissez ces herbes. Vous les avez étudiées en cours de biologie dans votre jeunesse. Ce sont des herbes Cura qui, mélangées à de l'eau, permettent de constituer un antidote à n'importe quel poison. Bien sûr, si vous n'êtes pas empoisonné, cette découverte n'a aucun intérêt (sauf si vous veniez à vous faire empoisonner d'ici la fin de votre aventure). Si vous êtes empoisonné, vous vous mettez en quête d'un petit cours d'eau que vous trouvez non loin de là. Vous mélangez les herbes avec l'eau et vous obtenez un liquide turquoise que vous buvez avec empressement. Stoppez immédiatement tous les effets que vous auriez pu subir à cause de l'empoisonnement.<span class=\"Apple-converted-space\"> </span></span><br/></p>"
	},
	{
		"_id" : {
		...
		"text" : "<p>Après une longue randonnée peu reposante (ajoutez un point au temps écoulé), vous atteignez un croisement entre quatre chemins. Celui de nord mène à l'autre côté de la forêt où il vous semble apercevoir un bâtiment de bois. La piste ouest serpente le long de la forêt et vous ne parvenez pas à en voir le bout. Le sentier de l'est se dirige vers une vieille bâtisse en bois. Enfin, le chemin du sud aboutit au cœur de la forêt, vers des arbres épineux. Quelle direction allez-vous emprunter ?<br/></p>"
	},
	{
		"_id" : {
	...
	},
	{
		...
		"__v" : 0,
		"title" : "24",
		"text" : "<p><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">D'un coup bien placé, vous réussissez à abîmer l'un des barreaux de la cage. Vous répétez l'opération plusieurs fois jusqu'à ce que le barreau se casse entièrement. Le lutin, tout joyeux, sort alors de sa cage et exécute une petite danse de victoire.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Je vous remercie de m'avoir tiré des griffes de la personne qui avait placé cette cage. Comme promis, vous aurez le droit à une récompense digne de votre effort. Que désirez-vous ? Du temps, de la force ou des richesses ?<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><br/></p>"
	},
	{
		"_id" : {
	...
	},
	{
		...
		"text" : "<p><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Vous demandez au lutin d'acquérir du temps :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Les humains disent que le temps passe. Le Temps dit que les humains passent, vous répond-il.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Sur ce, il claque des doigts et vous vous sentez aspiré par un tourbillon d'étoiles. Quand vos pieds retouchent le sol, vous constatez que vous êtes revenu en arrière. Grâce à ce sort, diminuez de deux points le temps écoulé. Ensuite, le lutin ayant disparu, vous poursuivez votre chemin.<span class=\"Apple-converted-space\"> </span></span><br/></p>"
	},
	{
		"_id" : {
	...
	},
	{
		...
		"text" : "<p><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Vous vous dirigez vers l'est, là où le temps s'assombrit. Une brume flotte dans l'air, nappe ondoyante parmi les arbres figés dans leur mort, on aurait dit un océan agité par la houle. Le lieu vers lequel vous vous dirigez est infesté de toiles d'araignées qui s'accrochent à vos vêtements, et vous immobilisent peu à peu, jusqu'à ce que vous soyez prisonnier dans un cocon de toile. Comment allez-vous vous dégager de ces fils insupportables ?<span class=\"Apple-converted-space\"> </span></span><br/></p>"
	},
	{
		"_id" : {
		...
		"__v" : 4,
		"title" : "33",
		"text" : "<p><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Vous vous dépêtrez tant bien que mal de ces toiles d'araignées en les tranchant une à une à l'aide de votre arme. Ajoutez un point au temps écoulé. Vous retirez les derniers fils de vos riches habits à la main. Vous reprenez ensuite votre chemin, l'arme à la main, de peur de rencontrer quelque bête nuisible. Peu après, le chemin débouche sur une vaste clairière sombre. Peu après, le chemin débouche sur une vaste clairière sombre. La brume opaque rampe au ras du sol telle un énorme reptile laiteux. Quand vous distinguez enfin ce que recèle la clairière, un frisson d'horreur vous envahit et vous vous glacez d'effroi.<span class=\"Apple-converted-space\"> </span></span><br/></p>"
	},
	{
		"_id" : {
		...
		"__v" : 4,
		"title" : "41",
		"text" : "<p><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Vous vous contorsionnez du maximum que vous le pouvez et vous réussissez à vous libérer tant bien que mal de vos liens. Ajoutez un point au temps écoulé. Vous retirez les derniers fils de vos riches habits à la main. Vous reprenez ensuite votre chemin, l'arme à la main, de peur de rencontrer quelque bête nuisible. Peu après, le chemin débouche sur une vaste clairière sombre. Peu après, le chemin débouche sur une vaste clairière sombre. La brume opaque rampe au ras du sol telle un énorme reptile laiteux. Quand vous distinguez enfin ce que recèle la clairière, un frisson d'horreur vous envahit et vous vous glacez d'effroi.<span class=\"Apple-converted-space\"> </span></span><br/></p>"
	},
	{
		"_id" : {
		...
		"__v" : 0,
		"title" : "4",
		"text" : "<p><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Au prix d'un effort surhumain, vous réussissez à écarter vos bras et à vous débarrasser tant bien que mal de vos liens. Ajoutez un point au temps écoulé. Vous retirez les derniers fils de vos riches habits à la main. Vous reprenez ensuite votre route, l'arme à la main, de peur de rencontrer quelque bête nuisible. Peu après, le chemin débouche sur une vaste clairière sombre. La brume opaque rampe au ras du sol telle un énorme reptile laiteux. Quand vous distinguez enfin ce que recèle la clairière, un frisson d'horreur vous envahit et vous vous glacez d'effroi.<span class=\"Apple-converted-space\"> </span></span><br/></p>"
	},
	{
		"_id" : {
	...
	},
	{
		...
		"title" : "49",
		"description" : "Sage",
		"text" : "<p>Après une longue marche, vous atteignez une clairière qui comporte en son milieu une vieille bâtisse en bois vermoulu. Bizarrement, ce bâtiment est entouré par une sorte de neige blanche. Pourtant, le temps n'est pas propice à une telle intempérie. Dubitatif, vous vous demandez si cette «neige» ne recèle pas un quelconque piège.<br/></p>"
	},
	{
		"_id" : {
		...
		"title" : "20",
		"description" : "\"Neige\"",
		"text" : "<p><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">Avec précaution, vous posez votre pied sur la «neige». À votre grand soulagement, il ne se passe rien, si ce n'est un cri étouffé provenant de l'édifice. Vous continuez à marcher et une voix bourrue vous ordonne :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);text-align: justify;background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">- Arrêtez, vous ne voyez donc pas que vous êtes en train de piétiner ma barbe !<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);text-align: justify;background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">Stupéfait, vous touchez la matière sur laquelle vous marchiez. Il s'agit en effet d'une géante barbe ! Vous parcourez rapidement le reste du chemin vous menant à la bâtisse et vous ouvrez la porte. Dans le bâtiment se trouve un vieil homme dont la gigantesque barbe blanche recouvre le sol invisible. Le vieillard grogne :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);text-align: justify;background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">- Vous auriez pu faire attention ! Sortez de ma maison avant que je ne perde patience !<span class=\"Apple-converted-space\"> </span></span><br/></p>"
	},
	{
		"_id" : {
		...
		"__v" : 0,
		"title" : "37",
		"text" : "<p><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">Comment allez-vous bien pouvoir entrer dans cette masure ? À votre droite, vous remarquez un arbre au bois vermoulu dont les branches semblent assez solides pour que vous puissiez y grimper. C'est ce que vous vous empressez de faire, et une fois parvenu à une hauteur convenable, vous remarquez sur le toit de la cabane une lucarne par laquelle vous pourriez passer. Il ne vous reste plus qu'à atteindre cet objectif.<span class=\"Apple-converted-space\"> </span></span><br/></p>"
	},
	{
		"_id" : {
	...
	},
	{
		...
		"__v" : 7,
		"title" : "13",
		"text" : "<p><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">Le vieillard se présente comme étant Berus, le doyen du village Bellus.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);text-align: justify;background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">- Pourquoi vivez-vous à l'écart du village ? le questionnez-vous.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);text-align: justify;background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">- Je préfère vivre loin de la bêtise des hommes pour me développer et devenir maître de moi-même : «Celui qui est maître de lui-même est plus grand que celui qui est maître du monde», récite-t-il.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);text-align: justify;background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">- Et si vous connaissez les réponses aux questions, pouvez-vous répondre aux miennes ?<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);text-align: justify;background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">- Mais bien entendu ! Vous avez raison de poser des questions ! «Le sage est celui qui s'étonne de tout», vous indique-t-il.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);text-align: justify;background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">Vous lui racontez alors votre parcours et vous lui demandez s'il connaît l'une des syllabes du mot de pouvoir. Visiblement amusé par cette question, il vous apprend que l'une des syllabes du mot de pouvoir est «tion». Enfin, vous le quittez, enrichi par sa réponse et vous retournez à l'embranchement. Ajoutez un point au temps écoulé.</span><br/></p>"
	},
	{
		"_id" : {
		...
		"title" : "30",
		"description" : "Géant",
		"text" : "<p>La piste que vous prenez est en montée, et son ascension est des plus ardues. À plusieurs reprises, votre pied dérape sur une pierre plus traître que les autres et vous tombez lamentablement. Toutes ces chutes vous ont coûtées un point de constitution. Des relents néfastes envahissent vos narines et vous forcent à vous mettre le nez sous vos riches habits. Alors que vous alliez encore trébucher, vous vous raccrochez de justesse à une branche, mais une fois stable, vous constatez qu'elle était toute vermoulue et que si vous la teniez encore, elle se serait brisée et vous seriez encore tombé. Il s'en est fallut d'un cheveu ! Lorsqu'enfin, le chemin redevient plat, vous vous retrouvez nez à nez avec un géant d'au moins trois mètres de haut, possédant une massue dont la taille est égale à la vôtre ! Il bloque l'entrée d'un sentier sinueux menant à une sorte de village.<br/></p>"
	},
	{
		"_id" : {
		...
		"title" : "2",
		"text" : "<p><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">Vous inspirez profondément, puis adressez la parole au géant :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);text-align: justify;background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">- Y a-t-il un moyen d'emprunter l'un des deux passages qui se trouve derrière vous ?<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);text-align: justify;background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">- Moi… Azog, tuer… humains ! rugit-il.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);text-align: justify;background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">Pas de chance, vous êtes un humain ! Il entame un cri de guerre, brandit sa massue, et se jette sur vous. Le seul problème (pour lui), c'est qu'il s'est manifestement arrêté au milieu de son parcours pour pousser un cri de douleur :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);text-align: justify;background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">- Aaahh… mon dos ! Encore… bloqué !<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);text-align: justify;background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">Vous comprenez alors que sous le sortilège de vieillesse, le géant a vieilli et qu'il souffre de rhumatismes. Vous lui proposez alors de lui faire un massage au dos, à condition qu'il ne vous tue pas. Il accepte, et vous vous mettez au travail. N'ayant jamais fait un massage de votre vie, vous essayez de reproduire les gestes que font vos servantes. Le dos du géant ne facilite pas la tâche : il est si encrassé que vous avez l'impression de mettre vos mains dans la boue. Ajoutez un point au temps écoulé. Un peu plus tard, le géant vous remercie et vous propose de prendre un des deux chemins derrière lui en échange de seulement 5 pièces d'or.</span><br/></p>"
	},
	{
		"_id" : {
		...
		"description" : "Village",
		"title" : "15",
		"text" : "<p><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">Le chemin débouche sur un petit hameau. Une pancarte vermoulue indique : BELLUS. Des colonnes de fumée s'élèvent dans les airs sans que le moindre souffle ne dévie jamais leur trajectoire rectiligne. Vous n'êtes pas surpris lorsque, en entrant au village, vous ne voyez aucun enfant. Les rues sont désertes, tout le monde semble être resté chez soi. Vous ne voulez point rentrer dans les chaumières, de peur de déranger l'intimité des gens. Vous vous apprêtiez à repartir lorsque vous entendez un sanglot étouffé. Vous en cherchez l'origine et vous trouvez, près d'une fontaine aux eaux usées, un vieil homme assis sur un banc en se prenant la tête dans les mains. Vous vous en approchez et vous lui demandez ce qui le fait pleurer ainsi :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);text-align: justify;background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);text-align: justify;float: none;background-color: rgb(255, 255, 255);\">- C'est ma fille Linda, elle est partie après avoir subit le sortilège de vieillissement et je ne sais pas où elle est ! Je l'ai laissée ! Je n'ai pas fait mon devoir de père ! Où est-elle maintenant, ma pauvre petite chérie, où est-elle ? se lamente-t-il.<span class=\"Apple-converted-space\"> </span></span><br/></p>"
	},
	{
		"_id" : {
		...
		"text" : "<p><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Quand vous lui montrez la bague tressée, le visage du vieil homme s'éclaircit.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Vous l'avez trouvée ? Vous avez trouvé ma petite fille ! Dieu soit loué ! Moi qui la croyais perdue à tout jamais. Où l'avez-vous rencontrée ?<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Vous lui racontez alors toute l'histoire, comment vous l'avez sauvée des brigands, son récit… L'homme vous remercie, se présente comme Venos le père de Linda et vous demande ce qui pourrait vous aider en récompense. Vous lui racontez votre mission et il vous indique :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Allons chez Arcânus, le vieil érudit. Il connaît sûrement une des syllabes de ce mot !<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Sur ce, il vous emmène jusqu'à une vieille bâtisse délabrée dont les murs semblent sur le point de s'effondrer. Il toque doucement, et un vieillard chenu lui ouvre la porte.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- C'est pour quoi ? demande-t-il d'un ton bourru.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Venos lui expose alors la situation et l'érudit vous invite à entrer chez lui. Dans sa maison (si l'on peut employer ce terme), règne un capharnaüm indescriptible. Des parchemins se cachent dans les moindres recoins, des fioles sont entreposées dans le désordre, des livres traînent par terre… Arcânus débute :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Je ne connais qu'une seule syllabe de ce mot mais si cela peut vous aider, la voici : LA.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Vous gravez cette information dans votre tête, puis le sage vous invite à manger. Pressé mais de peur de l'offenser, vous acceptez le repas et vous reprenez un point de constitution. Ensuite, Arcânus et Venos vous souhaitent bonne chance et vous reprenez votre chemin, particulièrement confiant car vous avez trouvé une syllabe. Ajoutez un point au temps écoulé.</span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><br/></p>"
	},
	{
		"_id" : {
		...
		"__v" : 0,
		"title" : "36",
		"text" : "<p>Fatigué par tout votre parcours mais pressé de retrouver les quatre syllabes à temps, vous marchez à pas vifs vers le bâtiment en bois. Quand vous vous en approchez suffisamment, vous distinguez une enseigne indiquant : « La chope mousseuse ». Vous comprenez donc bien vite qu'il s'agit là d'une taverne.<br/></p>"
	},
	{
		"_id" : {
	...
	},
	{
		...
		"__v" : 0,
		"title" : "45",
		"text" : "<p><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Vous venez près des nains et vous leur demandez si vous pouvez vous joindre à eux. Ils acceptent avec un enthousiasme manifeste, se présentent comme étant les trois frères Biföm, Bifäm et Bifüm et vous demandent ce que vous venez faire ici. Vous leur racontez alors toute votre histoire et vous les interrogez sur les syllabes. Le plus vieux d'entre eux, Bifüm, vous répond :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Ah ça oui que j'en connais une des syllabes de ce stupide mot ! Je ne suis pas très enclin à la dévoiler aux inconnus mais je suis d'humeur joueuse aujourd'hui et je veux bien vous dire l'objet de votre quête si vous trouvez la carte que j'ai en main. Ce défi vous demandera sûrement beaucoup de logique et du temps de réflexion.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Sur ce, il sort comme par enchantement une carte de sa manche et la garde précieusement cachée. Il vous donne alors une liste de dix cartes possibles :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Le 10 de cœur<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Le valet de cœur<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- L'as  de cœur<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- La dame de pique<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Le roi de pique<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Le 9 de carreau<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Le valet de carreau<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Le 9 de trèfle<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Le 10 de trèfle<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- La dame de trèfle<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Maintenant, je vais dire séparément et respectivement à Biföm et à Bifäm le symbole et la valeur de cette carte, vous indique Bifüm.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Il se retourne alors vers ses deux compagnons et les prend un par un pour leur chuchoter quelque chose à l'oreille.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Je ne sais pas la carte que cache Bifüm mais je sais que Bifäm ne la sait pas non plus, vous révèle Biföm.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Au début, je ne savais pas quelle était la carte que cache Bifüm mais maintenant, je le sais, vous dit Bifäm.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Dans ce cas, je sais aussi la carte que cache Bifüm, termine Biföm.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Le vieux nain vous laisse le temps de digérer ces informations et vous demande :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Quelle est la carte que j'ai en main ?<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Prenez bien le temps de réfléchir.  Si vous ne trouvez pas ou si votre réponse est fausse, les nains vous rejettent et vous quittez la taverne, démoralisé. Ajoutez un point au temps écoulé et rendez-vous au 42.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><br/></p>"
	},
	{
		"_id" : {
		...
		"text" : "<p>Vous n'avez pas trouvé la bonne réponse ! Les nains vous rejettent et c'est dépité que vous quittez la taverne. Ajoutez un point au temps écoulé.<br/></p>"
	},
	{
		"_id" : {
		...
		"__v" : 7,
		"title" : "47",
		"text" : "<p><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Félicitations ! explose le nain. J'ai rarement vu quelqu'un d'aussi intelligent que vous ! Vous avez largement mérité votre syllabe : «NU».<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Sur ce, les nains vous offrent une bière et vous regagnez un point de constitution. Ensuite, vous les quittez et vous reprenez votre route, galvanisé par votre réussite. Ajoutez un point au temps écoulé.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><br/></p>"
	},
	{
		"_id" : {
	...
	},
	{
		...
		"__v" : 10,
		"title" : "17",
		"text" : "<p>Vous essayez de mettre à profit leur maladie de vieillesse pour les monter les uns contre les autres. Vous leur expliquez calmement, avec une superbe assurance, que le premier a cassé le casque du deuxième, que le deuxième a blessé le troisième et que le troisième a insulté le premier, et qu'ils se recherchaient depuis longtemps afin de se battre. Les orques boivent vos paroles comme du petit lait et commencent à s'entretuer. Vous fermez les yeux, écœuré par le sang et la rage des orques. Un instant plus tard, il ne reste que trois cadavres couverts de sang. Ensuite, vous commencez à les fouiller. Ils ne possédaient pas grand chose qui ait de la valeur, si ce n'est deux misérables pièces d'or. Ajoutez un point au temps écoulé.<br/></p>"
	},
	{
		"_id" : {
	...
	},
	{
		...
		"__v" : 3,
		"text" : "<p><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Vous reprenez votre chemin et la végétation s'intensifie, vous remarquez même quelques feuilles sur certains des arbres. C'est alors que d'un arbre sort une silhouette dont le corps est entièrement fait de bois. C'est une nymphe des bois. Elle se rapproche de vous et vous adresse la parole :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- Je me nomme Orma et je te remercie d'avoir tué ces orques. Avec leurs haches dévastatrices, ils ont rasé une partie de cette forêt et ont tué plusieurs de mes consœurs sans aucune pitié. Et si tu ne les avais pas attirés au moment où ils allaient trancher mon arbre, un orme, je serais morte à l'heure qu'il est. Comment puis-je te récompenser ?<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Vous expliquez alors à Orma votre parcours et vous lui demandez si elle connaît l'une des syllabes du mot de pouvoir. Visiblement amusée par cette question, elle vous apprend que l'une des syllabes du mot de pouvoir est «AN». Ensuite, elle reprend sa place dans son orme et d'une voix caverneuse, elle vous souhaite bonne chance.</span><br/></p>",
		"title" : "39"
	},
	{
		"_id" : {
		...
		"__v" : 5,
		"text" : "<p><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Vous demandez au lutin d'obtenir des richesses :<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">- L'argent ne fait pas le bonheur, vous répond-il d'un ton froid, visiblement déçu de votre souhait.<span class=\"Apple-converted-space\"> </span></span><br style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"/><span style=\"color: rgb(85, 85, 85);float: none;background-color: rgb(255, 255, 255);\">Puis, il tape dans ses mains et une bourse bien ronde apparaît à vos pieds. Vous constatez avec satisfaction qu'elle contient cinquante pièces d'or. Ensuite, le lutin vous quitte, et vous poursuivez votre chemin.</span><br/></p>",
		"title" : "19",
	...
	},
	{
		...
		"__v" : 8,
		"title" : "44",
		"text" : "<p>D'un mouvement digne des plus grands épéistes, vous sortez votre arme du fourreau et transpercez le cœur du premier orque. Décontenancés, les deux autres orques mettent du temps à réagir et vous en profitez pour trancher net la gorge du second. Enfin, après un bref duel face au troisième, vous lui plantez votre dague entre les deux yeux. Ceux-ci roulent sur leurs orbites et après un long râle d'agonie, votre dernier adversaire meurt. Puis, d'un geste hautain, vous repoussez les gouttes de sang qui ont tâché votre tenue et vous fouillez les orques. Ils ne possédaient pas grand chose qui ait de la valeur, si ce n'est deux misérables pièces d'or. Ajoutez un point au temps écoulé.<br/></p>"
	},
	{
		"_id" : {
